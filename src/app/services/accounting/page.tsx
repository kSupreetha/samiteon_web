...
export const metadata: Metadata = {
  title: "Accounting Services — Samiteon",
  description: "Ensure financial success with Samiteon's expert accounting services and accurate financial management.",
};
    ...
    <main className="min-h-screen pt-24 text-slate-900 dark:text-slate-100">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 px-6 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-7xl">
          <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-emerald-400">Services</p>
          <h1 className="max-w-3xl text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
            Accurate Financial Management
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">
            Ensure financial success with Samiteon's expert accounting services and accurate financial management tailored to your business needs.
          </p>
          <div className="mt-10 flex flex-wrap gap-4">
            <Link href="/contact" className="rounded-lg bg-emerald-600 px-8 py-3 font-semibold text-white shadow-lg transition hover:bg-emerald-500">Inquire Now</Link>
      ...
      <div className="relative h-72 w-full sm:h-96 lg:h-[28rem]">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-10">
          <p className="text-xs font-semibold uppercase tracking-widest text-emerald-300">Industry Focus</p>
          <h2 className="mt-1 text-2xl font-bold text-white sm:text-3xl">Comprehensive Accounting Solutions for Diverse Industries</h2>
        </div>
      </div>
      <section className="w-full bg-white px-6 py-14 dark:bg-slate-950">
        <div className="mx-auto max-w-7xl">
          <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-300">
            At Samiteon, we offer expert accounting services tailored to meet the unique needs of diverse industries. Our comprehensive solutions ensure accuracy, efficiency, and compliance.
          </p>
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            {[
              { title: "Industry Focus", body: "We understand the specific accounting requirements of different industries and provide customized solutions.", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
              { title: "Streamlined Processes", body: "Our streamlined processes ensure efficient financial management and accurate reporting for your business.", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
            ].map(({ title, body, icon }) => (
        ...
        <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <div className="mb-4 flex items-center gap-3"><span className="h-8 w-1.5 rounded-full bg-emerald-500" />
              <h2 className="text-2xl font-bold tracking-tight lg:text-3xl">Comprehensive Accounting Services for All Your Financial Needs</h2>
            </div>
            <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              At Samiteon, we offer a wide range of accounting services to help businesses manage their finances effectively. Our experienced team provides bookkeeping, financial reporting, and tax preparation services, ensuring accuracy and compliance. With our expertise, you can focus on growing your business while we take care of your financial needs.
            </p>
            <ul className="mt-6 space-y-2">
              {["Bookkeeping & ledger management", "Financial reporting & analysis", "Tax preparation & compliance", "Payroll processing"].map(item => (
      ...
      <section className="w-full border-t border-slate-200 bg-white px-6 py-16 dark:border-slate-800 dark:bg-slate-950">
        <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            <div className="mb-4 flex items-center gap-3"><span className="h-8 w-1.5 rounded-full bg-emerald-500" />
              <h2 className="text-2xl font-bold tracking-tight lg:text-3xl">Advanced Technology for Accurate and Timely Accounting</h2>
            </div>
            <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-300">
              At Samiteon, we leverage advanced software and technology to deliver accurate and timely accounting services. Our expertise ensures that your financial records are managed efficiently and in compliance with industry standards.
            </p>
            <div className="mt-6 space-y-3">
              {["Streamlined Financial Reporting and Analysis", "Automated Bookkeeping and Transaction Processing", "Secure Data Management and Confidentiality"].map(item => (
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative h-64 w-full sm:h-80">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
            <h2 className="text-3xl font-bold text-white sm:text-4xl">Transform Your Accounting Services Today</h2>
            <p className="mt-4 max-w-xl text-lg text-emerald-100">Discover how Samiteon's comprehensive accounting services can streamline your financial processes.</p>
            <Link href="/contact" className="mt-8 rounded-lg bg-white px-10 py-4 font-bold text-emerald-700 shadow-lg transition hover:bg-emerald-50">Inquire</Link>
          </div>
        </div>
      </section>
